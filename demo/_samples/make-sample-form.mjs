...
// A4 한 페이지에 맞춘 회의록(정보표 + 안건표 + 결정/비고).
const body =
  para("회의록", "Title") +
  infoTable +
  para("안건 및 논의 내용", "Heading1") +
  agendaTable +
  para("결정 사항 요약", "Heading1") +
  para("결정 사항: ") +
...
<w:styles xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:style w:type="paragraph" w:styleId="Normal"><w:name w:val="Normal"/></w:style><w:style w:type="paragraph" w:styleId="Title"><w:name w:val="Title"/><w:pPr><w:jc w:val="center"/></w:pPr><w:rPr><w:b/><w:sz w:val="44"/></w:rPr></w:style><w:style w:type="paragraph" w:styleId="Heading1"><w:name w:val="heading 1"/><w:rPr><w:b/><w:sz w:val="28"/></w:rPr></w:style></w:styles>`;
